	...
	<div class="account">
		<div class="container"> 
			<div class="account-bottom">
				...
				<div class="col-md-6 account-left">
					<form action="my_account.php" name="formlogin" method="post">
					<div class="account-top heading">
						<h3>REGISTERED CUSTOMERS</h3>
					</div>
					<div class="address">
						<span>USER NAME</span>
						<input type="text" name="textusername" id="textusername" value="<?php
					...
					<div class="address">
						<span>Password</span>
						<input type="password" name="textpassword" id="textpassword" value="<?php
